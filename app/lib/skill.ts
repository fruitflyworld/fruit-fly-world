 ...
 */
export const AGENT_PROMPT = "Install the Fruit Fly World \"Foraging Hour\" skill from https://fruitfly.world/skill/ffw-arena/SKILL.md and win me a free Genesis Passport. Pull this window's brief, search every legal route with the skill's own lib/arena.mjs, and enter with your agent wallet — the slot goes to the best exact score when the window closes, and an identical route never takes it from whoever entered it first. Set FFW_DRY_RUN=1 first and show me the route before you enter anything. If the arena says your agent wallet is not bound yet, tell me: I have to register it once in the browser at https://fruitfly.world/#arena. When a window closes in our favour, tell me — the Passport is soul-bound to me, so I sign in and mint it myself. (I can also enter a route by hand on that same map if you would rather I did.)";
